...
public class Element extends Node
{
    ...
    public Element(final Tag tag, final String baseUri, final Attributes attributes) {
        ...
        this.childNodes = Element.EMPTY_NODES;
    ...
    protected List<Node> ensureChildNodes() {
        if (this.childNodes == Element.EMPTY_NODES) {
    ...
    protected Element doClone(final Node parent) {
        ...
        (clone.childNodes = new NodeList(clone, this.childNodes.size())).addAll(this.childNodes);
        return clone;
    }
