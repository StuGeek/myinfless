...
public class Parser
{
    ...
    public Document parseInput(final String html, final String baseUri) {
        ...
        return this.treeBuilder.parse(new StringReader(html), baseUri, this.errors, this.settings);
    }
    
    public Document parseInput(final Reader inputHtml, final String baseUri) {
        this.errors = (this.isTrackErrors() ? ParseErrorList.tracking(this.maxErrors) : ParseErrorList.noTracking());
        return this.treeBuilder.parse(inputHtml, baseUri, this.errors, this.settings);
    }
