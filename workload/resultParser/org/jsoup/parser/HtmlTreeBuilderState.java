...
enum HtmlTreeBuilderState
{
    Initial(0) {
        ...
        boolean process(final Token t, final HtmlTreeBuilder tb) {
            ...
            if (t.isComment()) {
                ...
                final DocumentType doctype = new DocumentType(tb.settings.normalizeTag(d.getName()), d.getPublicIdentifier(), d.getSystemIdentifier());
    ...
    InBody(6) {
        ...
        boolean anyOtherEndTag(final Token t, final HtmlTreeBuilder tb) {
            final String name = tb.settings.normalizeTag(t.asEndTag().name());
            final ArrayList<Element> stack = tb.getStack();
        ...
        boolean process(final Token t, final HtmlTreeBuilder tb) {
            ...
            Label_0310: {
                switch (t.type) {
                    ...
                    case StartTag: {
                        final Token.StartTag startTag = t.asStartTag();
                        final String normalName = startTag.normalName();
                        switch (normalName) {
                            case "html": {
        ...
        boolean process(final Token t, final HtmlTreeBuilder tb) {
            switch (t.type) {
                ...
                case EndTag: {
                    ...
                    final String name = normalName = end.normalName();
                    switch (normalName) {
                        case "optgroup": {
    ...
    InFrameset(18) {
        ...
        boolean process(final Token t, final HtmlTreeBuilder tb) {
            if (isWhitespace(t)) {
                ...
                if (t.isStartTag()) {
                    final Token.StartTag start = t.asStartTag();
                    final String normalName = start.normalName();
                    switch (normalName) {
                        case "html": {
    ...
    static final class Constants
    {
        ...
        static final String[] InBodyStartPreListing;
        static final String[] InBodyStartLiBreakers;
        static final String[] DdDt;
        static final String[] Formatters;
        static final String[] InBodyStartApplets;
        static final String[] InBodyStartEmptyFormatters;
        static final String[] InBodyStartMedia;
        static final String[] InBodyStartInputAttribs;
        static final String[] InBodyStartOptions;
        static final String[] InBodyStartRuby;
