...
public final class CharArrayBuffer implements CharSequence, Serializable
{
    ...
    public String substringTrimmed(final int beginIndex, final int endIndex) {
        ...
        int beginIndex2 = beginIndex;
        int endIndex2 = endIndex;
        while (beginIndex2 < endIndex && HTTP.isWhitespace(this.buffer[beginIndex2])) {
            ++beginIndex2;
        }
        while (endIndex2 > beginIndex2 && HTTP.isWhitespace(this.buffer[endIndex2 - 1])) {
            --endIndex2;
        }
        return new String(this.buffer, beginIndex2, endIndex2 - beginIndex2);
    }
