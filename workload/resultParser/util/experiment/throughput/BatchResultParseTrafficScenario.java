...
public class BatchResultParseTrafficScenario
{
    private static Map<String, Float> profileMap;
    private static List<Integer> qpsList;
    
    static {
        BatchResultParseTrafficScenario.profileMap = new HashMap<String, Float>();
        BatchResultParseTrafficScenario.qpsList = new ArrayList<Integer>();
    }
    
    public static void main(final String[] args) throws IOException {
        BatchResultParseTrafficScenario.qpsList = new FileOperation().readIntFile("C:\\Users\\DELL\\Desktop\\pieces\u7ed3\u679c\\workload\\traffic\\resnet-50.csv");
        ...
        for (final String item : list) {
            ...
            BatchResultParseTrafficScenario.profileMap.put(String.valueOf(splits[1]) + "_" + splits[2] + "_" + splits[3], latency);
        }
        final String filePath = "C:\\Users\\DELL\\Desktop\\pieces\u7ed3\u679c\\\u8c03\u5ea6\u6548\u7387\\traffic\\";
        final String fileName = "200ssd_400res_600mobile_200msSLO_1800sLen.log2";
        new BatchResultParseTrafficScenario().readStringFile(filePath, fileName);
    }
    ...
    public void readStringFile(final String filePath, final String fileName) throws IOException {
        ...
        for (int i = 0; i < size; ++i) {
            if (list.get(i).equals("")) {
                sumqps += BatchResultParseTrafficScenario.qpsList.get(i);
                writer.write(BatchResultParseTrafficScenario.qpsList.get(i) + "," + 0 + "," + 0 + "," + 0 + "," + 0 + "," + 0 + "," + "," + 0 + "," + 0 + "," + 0 + "\n");
            }
            else {
                ...
                final float latency = BatchResultParseTrafficScenario.profileMap.get(String.valueOf(cpuCore) + "_" + gpuCore + "_" + batchSize);
                final int throughtPerInstance = (int)(1000.0f / latency * batchSize);
                final int numberOfInstance = (int)Math.ceil(BatchResultParseTrafficScenario.qpsList.get(i) * 1.0 / throughtPerInstance);
                writer.write(BatchResultParseTrafficScenario.qpsList.get(i) + "," + throughtPerInstance * numberOfInstance + "," + cpuCore * numberOfInstance + "," + cpuCore * 64 * numberOfInstance + "," + gpuCore * numberOfInstance + "," + gpuCore * 142 * numberOfInstance + "," + (cpuCore * 64 * numberOfInstance + gpuCore * 142 * numberOfInstance) + "," + batchSize + "," + throughtPerInstance + "," + numberOfInstance + "\n");
                sumqps += BatchResultParseTrafficScenario.qpsList.get(i);
