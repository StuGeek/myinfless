...
public class MimeUtility
{
    ...
    public static String decodeWord(final String eword) throws ParseException, UnsupportedEncodingException {
        ...
        final int lpos = charset.indexOf(42);
        if (lpos >= 0) {
    ...
    static {
        MimeUtility.decodeStrict = PropUtil.getBooleanSystemProperty("mail.mime.decodetext.strict", true);
        MimeUtility.encodeEolStrict = PropUtil.getBooleanSystemProperty("mail.mime.encodeeol.strict", false);
        MimeUtility.ignoreUnknownEncoding = PropUtil.getBooleanSystemProperty("mail.mime.ignoreunknownencoding", false);
        MimeUtility.foldEncodedWords = PropUtil.getBooleanSystemProperty("mail.mime.foldencodedwords", false);
        MimeUtility.foldText = PropUtil.getBooleanSystemProperty("mail.mime.foldtext", true);
