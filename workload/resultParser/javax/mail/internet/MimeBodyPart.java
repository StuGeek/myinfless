...
public class MimeBodyPart extends BodyPart implements MimePart
{
    ...
    public DataHandler getDataHandler() throws MessagingException {
        if (this.dh == null) {
            this.dh = new MimePartDataHandler((DataSource)new MimePartDataSource(this));
        }
        return this.dh;
    }
    ...
    static {
        MimeBodyPart.setDefaultTextCharset = PropUtil.getBooleanSystemProperty("mail.mime.setdefaulttextcharset", true);
        MimeBodyPart.setContentTypeFileName = PropUtil.getBooleanSystemProperty("mail.mime.setcontenttypefilename", true);
        MimeBodyPart.encodeFileName = PropUtil.getBooleanSystemProperty("mail.mime.encodefilename", false);
        MimeBodyPart.decodeFileName = PropUtil.getBooleanSystemProperty("mail.mime.decodefilename", false);
        MimeBodyPart.cacheMultipart = PropUtil.getBooleanSystemProperty("mail.mime.cachemultipart", true);
    }
    
    static class MimePartDataHandler extends DataHandler
    {
        public MimePartDataHandler(final DataSource ds) {
            super(ds);
        }
    }
}
