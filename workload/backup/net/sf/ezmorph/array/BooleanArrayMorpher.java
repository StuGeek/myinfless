...
public final class BooleanArrayMorpher extends AbstractArrayMorpher
{
    ...
    static {
        Class class$0;
        if ((class$0 = BooleanArrayMorpher.class$0) == null) {
            try {
                class$0 = (BooleanArrayMorpher.class$0 = Class.forName("[Z"));
            }
            catch (ClassNotFoundException ex) {
                throw new NoClassDefFoundError(ex.getMessage());
            }
        }
        BOOLEAN_ARRAY_CLASS = class$0;
    }
    ...
    public BooleanArrayMorpher(final boolean defaultValue) {
        super(true);
    ...
    public boolean equals(final Object obj) {
        ...
        final BooleanArrayMorpher other = (BooleanArrayMorpher)obj;
    ...
    public Object morph(final Object array) {
        ...
        if (BooleanArrayMorpher.BOOLEAN_ARRAY_CLASS.isAssignableFrom(array.getClass())) {
            return array;
        }
        if (array.getClass().isArray()) {
            ...
            final Object result = Array.newInstance(Boolean.TYPE, dimensions);
            final BooleanMorpher morpher = this.isUseDefault() ? new BooleanMorpher(this.defaultValue) : new BooleanMorpher();
            if (dims == 1) {
    ...
    public Class morphsTo() {
        return BooleanArrayMorpher.BOOLEAN_ARRAY_CLASS;
    }
}
