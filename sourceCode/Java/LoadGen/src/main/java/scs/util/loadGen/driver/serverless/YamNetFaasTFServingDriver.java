 ...
 *
 */
public class YamNetFaasTFServingDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static YamNetFaasTFServingDriver driver=null;	
	
	//private StringBuilder builder=new StringBuilder();
	
	public YamNetFaasTFServingDriver(){initVariables();}
	public synchronized static YamNetFaasTFServingDriver getInstance() {
		if (driver == null) {
			driver = new YamNetFaasTFServingDriver();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=Repository.yamNetFaasBaseURL;
		jsonParmStr=Repository.yamNetParmStr;
