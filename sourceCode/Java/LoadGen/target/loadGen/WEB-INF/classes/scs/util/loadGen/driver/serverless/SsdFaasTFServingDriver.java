 ...
 *
 */
public class SsdFaasTFServingDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static SsdFaasTFServingDriver driver=null;	
	
	//private StringBuilder builder=new StringBuilder();
	
	public SsdFaasTFServingDriver(){initVariables();}
	public synchronized static SsdFaasTFServingDriver getInstance() {
		if (driver == null) {
			driver = new SsdFaasTFServingDriver();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=Repository.ssdFaasBaseURL;
		jsonParmStr=Repository.ssdParmStr;
