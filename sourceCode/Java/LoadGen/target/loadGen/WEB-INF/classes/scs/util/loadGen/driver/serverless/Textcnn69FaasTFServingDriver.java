 ...
 *
 */
public class Textcnn69FaasTFServingDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static Textcnn69FaasTFServingDriver driver=null;	
	
	//private StringBuilder builder=new StringBuilder();
	
	public Textcnn69FaasTFServingDriver(){initVariables();}
	public synchronized static Textcnn69FaasTFServingDriver getInstance() {
		if (driver == null) {
			driver = new Textcnn69FaasTFServingDriver();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=Repository.textcnn69FaasBaseURL;
