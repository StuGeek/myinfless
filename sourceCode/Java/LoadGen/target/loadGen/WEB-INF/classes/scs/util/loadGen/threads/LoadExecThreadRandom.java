 ...
 *
 */
public class LoadExecThreadRandom extends Thread{
	 ...
	 * @param url 要访问的链接 
	 */
	public LoadExecThreadRandom(CloseableHttpClient httpclient,String url,CountDownLatch begin,int serviceId,String jsonObjectStr, int sendDelay, String requestType){
