 ...
 *
 */
public class LstmFaasTFServingDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static LstmFaasTFServingDriver driver=null;	
	
	//private StringBuilder builder=new StringBuilder();
	
	public LstmFaasTFServingDriver(){initVariables();}
	public synchronized static LstmFaasTFServingDriver getInstance() {
		if (driver == null) {
			driver = new LstmFaasTFServingDriver();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=Repository.lstm2365FaasBaseURL;
